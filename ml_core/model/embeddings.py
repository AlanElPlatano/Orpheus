...
class ScaleDegreeEmbedding(nn.Module):
    ...
    both the major 3rd (scale degree 4), regardless of the absolute pitch.
...
class MusicEmbedding(nn.Module):
    ...
    def __init__(
        ...
        # Scale degree embeddings (optional, Phase 2)
    ...
    def forward(
        ...
        # Add scale degree embeddings if provided and enabled (Phase 2)
